...
/***/ "./src/kintone-env-dependent-char.ts":
/*!*******************************************!*\
  !*** ./src/kintone-env-dependent-char.ts ***!
  \*******************************************/
...
(function () {
  ...
  kintone.events.on("app.record.detail.show", function (event) {
    try {
      ...
      // フィールド名を配列で定義
      var fieldCodes = ['ユタカ出し', '住所1', '住所2', '個人名_団体', '個人名_団体_フリガナ', '実納品時間', '担当者_名', '担当者_名_フリガナ', '担当者_姓', '担当者_姓_フリガナ', '注文者', '注文商品名', '注文日', '納品書', '請求書', '都道府県', '配送業者', '領収書', '郵便番号1', '郵便番号2'];
  ...
  kintone.events.on("app.record.index.show", function (event) {
    ...
    button.onclick = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _document$getElementB, client, APP_ID, getAllRecordsParams, getAllRecordsResp, nonJISRegex, targetRecords;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkyutaka_test_shipping_information"] = self["webpackChunkyutaka_test_shipping_information"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_kintone_rest-api-client_lib_src_index_browser_js"], () => (__webpack_require__("./src/kintone-env-dependent-char.ts")))
